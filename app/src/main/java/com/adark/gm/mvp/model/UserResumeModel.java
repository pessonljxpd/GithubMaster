...
@ActivityScope
public class UserResumeModel extends BaseModel<ServiceManager, CacheManager> implements UserResumeContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public UserResumeModel(ServiceManager pServiceManager, CacheManager pCacheManager, Gson pGson,
