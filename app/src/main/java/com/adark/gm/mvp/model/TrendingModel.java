...
@ActivityScope
public class TrendingModel extends BaseModel<ServiceManager, CacheManager> implements TrendingContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public TrendingModel(ServiceManager pServiceManager, CacheManager pCacheManager, Gson pGson,
