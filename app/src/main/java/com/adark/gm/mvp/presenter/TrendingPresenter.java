...
@ActivityScope
public class TrendingPresenter extends BasePresenter<TrendingContract.Model, TrendingContract.View> {
    ...
    @Inject
    public TrendingPresenter(TrendingContract.Model pModel, TrendingContract.View pRootView
